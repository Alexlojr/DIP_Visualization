...
FILTER_PARAMS = {
    ...
    "Bilateral":                 ("Kernel:",         3,    15,   5),
    "Sobel":                     (None,              0,    1,    0),
    "Laplacian":                 (None,              0,    1,    0),
    "Prewitt":                   (None,              0,    1,    0),
    "Roberts Cross":             (None,              0,    1,    0),
    "Sharpen":                   (None,              0,    1,    0),
    "Emboss":                    (None,              0,    1,    0),
...
class MainWindow(QMainWindow):
    ...
    def _build_filter_call(self, name: str, val: int):
        ...
        from src.Algorythms.filters import (
            ...
            bilateral_filter, roberts_cross_filter, emboss_filter,
        )
        from src.Algorythms.transformations import (
            ...
            ascii_art_filter, heatmap_filter,
        ...
        dispatch = {
            ...
            "Bilateral":                 (bilateral_filter,      (img,), {"kernel_size": odd_val}),
            "Sobel":                     (sobel_filter,          (img,), {}),
            "Laplacian":                 (laplacian_filter,      (img,), {}),
            "Prewitt":                   (prewitt_filter,        (img,), {}),
            "Roberts Cross":             (roberts_cross_filter,  (img,), {}),
